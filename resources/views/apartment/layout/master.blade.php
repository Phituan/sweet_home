...
<head>
    ...
    <title>{{__('message.site_slogan')}}</title>
</head>
<body>
<nav class="navbar navbar-light bg-light">
    <div class="col-md-3">
        ...
        <div class="text-muted mt-4">{{__('message.site_slogan')}}</div>
    </div>
...
<div class="container-fluid row mt-3">
    <div class="col-md-3">
        <div class="nav flex-column nav-pills" role="tablist">
            <a class="nav-link" href="/admin/product" role="tab"><i class="fas fa-home mr-2"></i>{{__('message.home')}}</a>
            <a class="nav-link{{$current_page=='product_manager'?' active':''}}" href="/admin/product"><i class="fas fa-piggy-bank mr-2"></i>{{__('message.pig_mânger')}}</a>
